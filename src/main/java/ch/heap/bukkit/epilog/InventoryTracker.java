...
public class InventoryTracker {
	...
	public InventoryTracker(Epilog el) {
		...
		try {
			...
			eventNames = Arrays.asList(
					...
					"PlayerRespawnEvent", "PlayerItemHeldEvent", "PlayerPickupItemEvent", "PlayerDropItemEvent",
					"InventoryCloseEvent", "PlayerItemBreakEvent", "BlockPlaceEvent", "PlayerItemConsumeEvent",
					"ProjectileLaunchEvent", "PlayerJoinEvent", "CraftItemEvent");
			method = this.getClass().getMethod("inventoryHandler", LogEvent.class);
			epilog.addEventObserver(this, method, eventNames);
			eventNames = Arrays.asList("InventoryOpenEvent", "InventoryCloseEvent", "InventoryClickEvent",
					"InventoryDragEvent", "BlockBreakEvent");
	...
	private void checkInventory(String eventName, Player player, long time, Map<UUID, InventoryContent> state,
			ItemStack[] content) {
